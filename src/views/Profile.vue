<template>
    <div class="profile mx-auto max-w-[1364px]">
          ...
          <span class="text-white uppercase bg-black py-1 px-sm absolute top-md left-lg tracking-md">
              News
                    ...
                    <div class="flex justify-between flex-1 items-end">
                        <h3 class="text-white text-lg2 text-bold uppercase tracking-md max-w-[250px] leading-[30px]">
                            Découvrez la
        ...
        <div class="grid grid-cols-12 mt-md2 gap-md">
            <div class="col-span-6">
                <div class="grid grid-cols-12 gap-x-sm gap-y-md2">
                    <div class="col-span-6">
                        <Tile>
                            <span class="block text-primary text-md uppercase tracking-md">Max dégâts dans une partie</span>
                            <span class="block text-white font-bold text-xl uppercase tracking-lg">{{
                    ...
                    <div class="col-span-6">
                        <Tile>
                            ...
                            <span class="block text-white font-bold text-xl uppercase tracking-lg">{{
                                    userStats?.traveledDistanceAverage / 1000
                                }}</span>
                        </Tile>
                    </div>
                </div>
            ...
            <div class="col-span-6">
                <span class="text-white text-md2 uppercase tracking-md">Parties récentes</span>
                <table>
                    <thead>
                        <th>Jeu</th>
                        <th>Joueur</th>
...
const getGameHistories = computed(() => gameHistories.value?.map((o) => ({
